      ...
      <div class="scale shadow my-4">
        ...
        <div class="card-body">
          ...
          <div class="card-image mb-2">
            ...
            @else
            <img src="https://images.unsplash.com/photo-1484821582734-6c6c9f99a672?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=500&q=60" class="img-fluid">
            @endif
          </div>
